...
- Esta skill esta pensada para invocacion explicita con `$balance-check`.
...
Extraer del argumento (`lo que el usuario pase al invocar la skill`) que sistema revisar.
