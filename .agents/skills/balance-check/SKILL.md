...
- Esta skill esta pensada para matching implicito y tambien para invocacion explicita con `$balance-check`.
...
- Si falta un dato menor, asume un baseline razonable y declaro antes de calcular; si faltan formulas o valores criticos, detente y pidelos.
