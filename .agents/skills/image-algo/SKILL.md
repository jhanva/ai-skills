---
name: image-algo
description: Diseña algoritmos de imagen como hashing, similarity, clustering o deduplicación. Úsala cuando el usuario pida explícitamente diseñar un algoritmo de procesamiento de imagen. No la uses para implementación directa sin haber definido el enfoque.
---
