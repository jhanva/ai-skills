...
No inyecta JS; es indistinguible de la accion nativa del browser.
...
1. **Clicks por coordenadas**: `click_at_xy()` atraviesa iframes a nivel compositor.
...
Es mas confiable que esperar idle de red para aplicaciones React/Vue/Angular que mutan el DOM asincronamente.
