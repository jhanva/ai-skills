...
Grep: "io.coil-kt" | "com.bumptech.glide" | "com.squareup.picasso"

# Direct bitmap operations
Grep: "BitmapFactory" | "Bitmap.createBitmap" | "Bitmap.createScaledBitmap"

# ML/Vision
Grep: "MediaPipe" | "MLKit" | "TensorFlow" | "ONNX"

# Image hashing
Grep: "MessageDigest" | "perceptualHash" | "phash" | "dhash"

# EXIF
Grep: "ExifInterface"

# Content loading
Grep: "ContentResolver" | "openInputStream" | "MediaStore"
```
