...
description: >
  Audita, habilita y repara soporte de symlinks en Windows para repos Git.
  Valida Developer Mode, permisos de administrador, core.symlinks, creacion
  real de symlinks, y recupera checkouts donde Git dejo links como archivos
  planos. Modos: audit, setup, repair.
