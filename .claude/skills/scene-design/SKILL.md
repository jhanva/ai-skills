...
name: scene-design
description: >
  Define scene design para entities (player, enemies, UI): node tree hierarchy,
  signals, scripts con responsabilidades, y data flow. Lee GDD del sistema,
  define estructura de nodos Godot (CharacterBody2D, AnimatedSprite2D,
  CollisionShape2D, etc), y genera design/scenes/{scene-name}.md con specs
