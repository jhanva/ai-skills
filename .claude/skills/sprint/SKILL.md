...
name: sprint
description: >
  Planificacion de sprint para desarrollo de juegos 2D pixel art en Godot 4.
  Lee el game concept, GDDs existentes, y sprint anterior para seleccionar 3-5 stories
  estimadas y con acceptance criteria claros. Output: production/sprints/sprint-{N}.md
  con sprint goal, stories seleccionadas, capacity, y rollover.
argument-hint: "[numero de sprint]"
